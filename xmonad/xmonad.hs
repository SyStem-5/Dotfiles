...
myWorkspaces    = ["web", "comms", "music", "4", "5", "6", "7", "8", "9", "0"]
...
myManageHook = composeAll . concat $
    ...
    myCFloats = ["Arandr", "Arcolinux-calamares-tool.py", "Arcolinux-tweak-tool.py", "Arcolinux-welcome-app.py", "Galculator", "feh", "mpv", "Xfce4-terminal", "Arcologout.py"]
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_h), spawn $ "kitty -c 'htop task manager' -e htop" )
  ...
  -- , ((controlMask .|. mod4Mask , xK_a ), spawn $ "xfce4-appfinder")
  -- , ((controlMask .|. mod1Mask , xK_e ), spawn $ "arcolinux-tweak-tool")
  -- , ((controlMask .|. mod1Mask , xK_m ), spawn $ "xfce4-settings-manager")
  , ((controlMask .|. modMask, xK_p), spawn $ "polybar-msg cmd toggle" )
  , ((controlMask .|. modMask , xK_o), spawn $ "$HOME/.xmonad/scripts/picom-toggle.sh")
  -- , ((controlMask .|. mod1Mask , xK_p ), spawn $ "pamac-manager")

  -- This is disabled because it is not that important to have a direct keybind
  ...
  --SCREENSHOTS
  , ((0, xK_Print), spawn $ "scrot 'ArcoLinux-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'; notify-send 'Screenshot' 'Screenshot taken'")
  ...
  --- , ((modMask, xK_Pause), spawn $ "playerctl next")
  --- , ((modMask .|. controlMask, xK_Pause), spawn $ "playerctl previous")
  ...
  -- Cycle through the available layout algorithms. (modMask .|. shiftMask, xK_d )
  -- , ((modMask, xK_space), sendMessage NextLayout)
  , ((modMask .|. shiftMask, xK_d ), sendMessage NextLayout)
  ...
  -- Focus screen
  , ((controlMask .|. modMask , xK_q ), nextScreen)
  , ((controlMask .|. modMask , xK_e ), prevScreen)
  ...
  , ((controlMask .|. modMask , xK_t), withFocused $ windows . W.sink)
